              ...
              : (E || i) &&
                ...
                (t = function (A, I, g) {
                  ...
                  (B.open("GET", A, !0),
                    ...
                    (B.onload = function () {
                      200 == B.status || (0 == B.status && B.response)
                        ? I(B.response)
                        : g();
                    }),
                    (B.onerror = g),
          ...
          var m,
                  ...
                  ((Q.asm = B),
                    ...
                    (function (A) {
                      if (
                        ...
                        0 == d &&
                          (null !== k && (clearInterval(k), (k = null)), J))
                      ) {
                        var I = J;
                        ((J = null), I());
                      }
            ...
            T =
              ...
              (Q._argon2_error_message = function () {
                return (Q._argon2_error_message = Q.asm.i).apply(
                  null,
                  arguments,
                );
              }),
